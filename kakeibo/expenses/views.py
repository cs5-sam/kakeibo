...
def search_expenses(request):
    if request.method == 'POST':
        ...
        expenses = Expense.objects.filter(
            amount__istartswith=search_str, owner = request.user) or Expense.objects.filter(
...
def expense_category_summary(request):
    ...
    expenses = Expense.objects.filter(owner=request.user, date__gte = one_month_ago, date__lte = today)
    finalrep = {}
